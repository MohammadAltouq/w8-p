...
import s_img from "../../assets/images/search.jpg"
    ...
    return (
        <Box sx={{display:'flex'}} >
            ...
            <Toolbar sx={myStyles.toolbar}>
                ...
                <Button sx={myStyles.toolbar_button} onClick={handleDialogClickOpen}>Add Hero</Button>
                    <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">Add New Hero </DialogTitle>
                    <DialogContent>
                        <img src={s_img} style={{width: '60%',display:'flex', margin:'auto' }}/>
                      <DialogContentText style={{width: '60%',display:'flex', margin:'auto'}}>How are you looking for? type exact name</DialogContentText>
                      <HeroForm />
                    </DialogContent>
                    <DialogActions>
